...
class InMessagesController extends Controller
{
    ...
    public $invalidCodeMessage = 'Thanks for participating in the Plascon Paint and Win promo. This code is invalid. Please check your paint container and try again or contact your Plascon dealer.';
    public $alreadyUsedMessage = 'Thanks for participating in the Plascon Paint and Win promo. This code has already been captured. Try another one or contact your local Plascon dealer.';
    public $closed = 'Thank you for taking part in the Plascon Paint and Win promotion. The promotion is currently closed. Look out for more exciting offers from Plascon. Ts n Cs apply.';
    public $blocked = 'Thank you for choosing Plascon. You are not eligible to participate in this Promo. See Ts and Cs on www.plascon.co.ug.';
